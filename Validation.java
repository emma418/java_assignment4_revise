...
/*
 * Student Name: Xiaoying Bian
 * Student ID: N01553051
 * Section: IGA
 * Logic: The class contains the methods used to validate the input.
 */
...
public class Validation {
	...
	private static final String[] FIELDS = { "ID", "Last name", "First name", "mi", "Adress", "City", "State",
			"Telephone" };
